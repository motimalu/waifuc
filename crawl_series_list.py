...
from waifuc.action.filter import BlacklistedTagFilterAction, ExistingDanbooruFileFilterAction, FileTypeFilterAction, MinAreaFilterAction, MinSizeFilterAction
...
if __name__ == '__main__':
    ...
    for name in list:
        output_dir = '/data/1_collection_name3/0_update/1_' + name
